...
{    
    public static LinkedHashSet computeClique(Graph graph) throws Exception
    {
        ...
        System.err.println("Computing Clique...");
        ...
        //System.err.println(clique.clique.size());
        ...
        for(int i=0; i<Constants.ANNEALING_ITERATIONS; i++)
        {
            ...
            //System.err.println("PA: " + clique.pa.size());
        ...
        //System.err.println("Randomized Algorithm Clique Size: " + maxClique);
        while(true)
        {
            boolean flag = false;
        ...
        System.err.println("Maximum Clique Size Found: " + gBest.size());
        System.err.println("Vertices in the Clique:");
    ...
    {
        System.err.println("Random Restarting...");
