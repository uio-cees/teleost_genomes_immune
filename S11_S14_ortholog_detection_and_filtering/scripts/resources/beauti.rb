...
# If a starting tree has been specified, starbeast is used, and starting tree taxa do not contain "_spc", add it.
...
if write_slurm
    ...
    slurm_string_start = "/usr/bin/java -jar -Xmx4g beast.jar -threads 3 -seed #{rand(100000)} -beagle #{analysis_id}.xml\n"
    slurm_string_resume = "/usr/bin/java -jar -Xmx4g beast.jar -threads 3 -seed #{rand(100000)} -beagle -resume #{analysis_id}.xml\n"
    slurm_string2 = ""
    slurm_string2 << "\n"
